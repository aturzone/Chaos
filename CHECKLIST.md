...
| L5 | **v0.0.28 — Any machine, any model**: quant selection, self-configuration | **[~]** `--auto` exists **for the dense path only** -- it makes zero decisions on DeepSeek-V4-Flash (C5g). T3/T4 open, and T4 now has a measured reason rather than a checkbox |
